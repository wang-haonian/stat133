...
plot(iris$Petal.Length,iris$Sepal.Width, xlab="Petal Length", ylab="Petal Width",
...
plot(infants$bwt~infants$gestation, pch="*", xlab="Gestation in days", ylab="Infant Birthweight",col="red")
abline(v=259)
# [6 pts]
